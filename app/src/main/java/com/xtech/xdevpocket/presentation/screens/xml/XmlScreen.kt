...
fun XmlScreen(
    ...
    Column(
        ...
        ToolHeader(title = "XML Formatter", subtitle = "Format, minify & validate", onBack = onBack)
        ...
        CodeOutput(
            ...
            trailingContent = {
                Row {
                    CopyButton(onClick = {
                        ClipboardHelper.copyToClipboard(context, "XML output", uiState.output)
